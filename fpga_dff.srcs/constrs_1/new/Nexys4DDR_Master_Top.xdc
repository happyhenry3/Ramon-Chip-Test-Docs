...
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { sel_uart_tx }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=sw[1]
...
set_property -dict { PACKAGE_PIN F18   IOSTANDARD LVCMOS33 } [get_ports { config_data_back }]; #IO_L22N_T3_A16_15 Sch=ja[9]
set_property -dict { PACKAGE_PIN G18   IOSTANDARD LVCMOS33 } [get_ports { tdc_data_back }]; #IO_L22P_T3_A17_15 Sch=ja[10]
