...
set_property PACKAGE_PIN U9 [get_ports {config_data_back}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {config_data_back}]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
set_property PACKAGE_PIN U8 [get_ports {tdc_data_back}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {tdc_data_back}]
...
set_property PACKAGE_PIN V5 [get_ports {test_fpga_sw7}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {test_fpga_sw7}]
...
set_property PACKAGE_PIN U7 [get_ports {test_fpga_led6 }]					
	set_property IOSTANDARD LVCMOS33 [get_ports {test_fpga_led6 }]
##Bank = 34, Pin name = IO_L22N_T3_34,						Sch name = LED7
set_property PACKAGE_PIN U6 [get_ports {test_fpga_led7}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {test_fpga_led7}]
##Bank = 34, Pin name = IO_L10N_T1_34,						Sch name = LED8
set_property PACKAGE_PIN V4 [get_ports {data_clk}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {data_clk}]
##Bank = 34, Pin name = IO_L8N_T1_34,						Sch name = LED9
set_property PACKAGE_PIN U3 [get_ports {uart_tx}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {uart_tx}]
##Bank = 34, Pin name = IO_L7N_T1_34,						Sch name = LED10
set_property PACKAGE_PIN V1 [get_ports {config_load }]					
	set_property IOSTANDARD LVCMOS33 [get_ports {config_load }]
##Bank = 34, Pin name = IO_L17P_T2_34,						Sch name = LED11
set_property PACKAGE_PIN R1 [get_ports {config_clk}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {config_clk}]
##Bank = 34, Pin name = IO_L13N_T2_MRCC_34,					Sch name = LED12
set_property PACKAGE_PIN P5 [get_ports {config_data}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {config_data}]
##Bank = 34, Pin name = IO_L7P_T1_34,						Sch name = LED13
set_property PACKAGE_PIN U1 [get_ports {tdc_input}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {tdc_input}]
##Bank = 34, Pin name = IO_L15N_T2_DQS_34,					Sch name = LED14
set_property PACKAGE_PIN R2 [get_ports {tdc_reset}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {tdc_reset}]
##Bank = 34, Pin name = IO_L15P_T2_DQS_34,					Sch name = LED15
set_property PACKAGE_PIN P2 [get_ports {read_enable}]					
...
set_property PACKAGE_PIN E16 [get_ports test_fpga_buttonc]						
	set_property IOSTANDARD LVCMOS33 [get_ports test_fpga_buttonc]
